...
import (
	...
	lowlevel "github.com/detahard/detahardd-go/usb/lowlevel/hidapi"
...
func (b *HIDAPI) match(d *lowlevel.HidDeviceInfo) bool {
	vid := d.VendorID
	pid := d.ProductID
	// note that "detahard1" is just the old hidapi one; t2 has the new vid/pid
...
// This will write a useless buffer to detahard
